...
bool parse::validateFormula(std::string str)
{
  ...
  if (formulatokenList[formulaTokensCount - 1].type == 6 || formulatokenList[formulaTokensCount - 1].type == 3 || formulatokenList[formulaTokensCount - 1].type == 4 || formulatokenList[formulaTokensCount - 1].type == 8)
    return false;
  ...
  if (formulaTokensCount == 2)
  {
    ...
    if (formulatokenList[0].type == 3)
    {
      ...
      if ((formulatokenList[1].type == 8 || formulatokenList[1].type == 6 || formulatokenList[1].type == 7 || formulatokenList[1].type == 1 || formulatokenList[1].type == 2))
      {
        return true;
      }
      else
  ...
  else
  {
    for (int i = 1; i < (formulaTokensCount - 1); i++)
    {
      if (formulatokenList[i].type == 2)
      {
        ...
        if ((formulatokenList[i - 1].type == 3 || formulatokenList[i - 1].type == 4 || formulatokenList[i - 1].type == 8 || formulatokenList[i - 1].type == 6) && (formulatokenList[i + 1].type == 3 || formulatokenList[i + 1].type == 4 || formulatokenList[i + 1].type == 7))
        {
          continue;
        }
        else
      ...
      {
        // std::cout << "Inside if(formulatokenList[i].type == 3)" << std::endl;
        if ((formulatokenList[i - 1].type == 7 || formulatokenList[i - 1].type == 1 || formulatokenList[i - 1].type == 2) && (formulatokenList[i + 1].type == 8 || formulatokenList[i + 1].type == 6 || formulatokenList[i + 1].type == 7 || formulatokenList[i + 1].type == 1 || formulatokenList[i + 1].type == 2))
        {
          continue;
        }
        else
      ...
      {
        // std::cout << "Inside if(formulatokenList[i].type == 8)" << std::endl;
        if ((formulatokenList[i - 1].type == 3 || formulatokenList[i - 1].type == 4 || formulatokenList[i - 1].type == 8 || formulatokenList[i - 1].type == 6) && (formulatokenList[i + 1].type == 6 || formulatokenList[i + 1].type == 1 || formulatokenList[i + 1].type == 2 || formulatokenList[i + 1].type == 8))
        {
          continue;
        }
        else
      ...
      {
        // std::cout << "Inside if(formulatokenList[i].type == 6)" << std::endl;
        if ((formulatokenList[i - 1].type == 3 || formulatokenList[i - 1].type == 4 || formulatokenList[i - 1].type == 8 || formulatokenList[i - 1].type == 6) && (formulatokenList[i + 1].type == 8 || formulatokenList[i + 1].type == 6 || formulatokenList[i + 1].type == 1 || formulatokenList[i + 1].type == 2))
        {
          continue;
        }
        else
      ...
      {
        // std::cout << "Inside if(formulatokenList[i].type == 7)" << std::endl;
        if ((formulatokenList[i - 1].type == 7 || formulatokenList[i - 1].type == 1 || formulatokenList[i - 1].type == 2) && (formulatokenList[i + 1].type == 3 || formulatokenList[i + 1].type == 4 || formulatokenList[i + 1].type == 7))
        {
          continue;
        }
        else
...
bool parse::validateAssignment(std::map<std::string, bool> table)
{
  ...
  for (int i = 1; i < (assignmentTokensCount - 1); i++)
  {
    ...
    {
      // std::cout << "Inside if(formulatokenList[i].type == 3)" << std::endl;
      if ((assignmenttokenList[i - 1].type == 10 || assignmenttokenList[i - 1].type == 1) && (assignmenttokenList[i + 1].type == 10 || assignmenttokenList[i + 1].type == 2))
      {
        continue;
      }
      else
